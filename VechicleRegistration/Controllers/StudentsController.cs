...
namespace VechicleRegistration.Controllers
{
    public class StudentsController : Controller
    {
        ...
        {
            var students = db.Students.Include(s => s.QRCodeDetails);
        ...
        {
            ViewBag.StudentID = new SelectList(db.QRCodes, "StudentID", "StudentID");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "StudentID,name,MatricNumber,StudentImage,ImageText,QrText,Department,Email,date_created,last_modified")] Student student)
        {
